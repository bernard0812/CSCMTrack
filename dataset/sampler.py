...
from .function import TensorDict
...
class TrackingSampler(torch.utils.data.Dataset):
    ...
    def _sample_visible_ids(self, visible, num_ids=1, min_id=None, max_id=None,
        ...
        if num_ids == 0:
            return []
        if min_id is None or min_id < 0:  # 不会出现
            min_id = 0
    ...
    def getitem(self):
        ...
        while not valid:
            ...
            try:
                template_frames, template_events, template_anno, meta_obj_train = dataset.get_frames(seq_id, template_frame_ids, seq_info_dict)

                search_frames, search_events, search_anno, meta_obj_test = dataset.get_frames(seq_id, search_frame_ids, seq_info_dict)
    ...
    def sample_seq_from_dataset(self, dataset, is_video_dataset):
        ...
        while not enough_visible_frames:
            ...
            # occlusion = seq_info_dict ['occlusion']
