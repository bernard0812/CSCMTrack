...
from tester.evaluation.data import Sequence
from tester.evaluation.tracker import Tracker
from dataset.image_loader import imwrite_indexed
import torch
...
def run_sequence(seq: Sequence, tracker: Tracker, debug=False, num_gpu=8):
    ...
    def _results_exist():
        ...
        # os.makedirs(bbox_file, exist_ok=True)
        a = os.path.isfile(bbox_file)
    ...
    print('Tracker: {} {} {} ,  Sequence: {}'.format(tracker.name, tracker.parameter_name, tracker.resume, seq.name))
